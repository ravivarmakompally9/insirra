...
export function NavBar({ items, className }) {
  ...
  return (
    <div
  className={cn(
    "fixed bottom-0 sm:top-0 left-1/2 -translate-x-1/2 z-50 mb-6 sm:pt-6 pointer-events-none", // 👈 add pointer-events-none
    className,
  )}
>
  <div className="flex items-center gap-3 bg-black/20 border border-neutral-700 backdrop-blur-lg py-1 px-1 rounded-full shadow-lg select-none pointer-events-auto">
    {items.map((item) => {
